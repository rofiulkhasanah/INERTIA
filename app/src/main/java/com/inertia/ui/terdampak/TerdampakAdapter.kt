...
class TerdampakAdapter : RecyclerView.Adapter<TerdampakAdapter.TerdampakViewHolder>() {
    ...
    private val listPenilaian = ArrayList<PenilaianEntity>()
                ...
                with(binding) {
                    ...
                    itemView.setOnClickListener {
                        ...
                        onItemClick = { selectedData ->
                            ...
                            intent.putExtra("idKasus", selectedData.idKasus)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TerdampakViewHolder {
        val binding = ItemTerdampakBinding.inflate(LayoutInflater.from(parent.context), parent, false)
